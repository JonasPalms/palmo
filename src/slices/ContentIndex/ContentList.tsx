...
export default function ContentList({
  ...
  return (
    <div ref={component}>
      <ul className="grid" onMouseLeave={onMouseLeave}>
            ...
            {isFilled.keyText(item.data.title) && (
              ...
              >
                <Link
                  ...
                  className="flex flex-col justify-between border-t border-t-slate-100 py-10 text-slate-200 last:border-b md:flex-row"
                >
