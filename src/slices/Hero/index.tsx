    ...
    >
      <div className="grid min-h-[70vh] grid-cols-1 md:grid-cols-2 items-center">
        ...
        <div className='col-start-1 md:row-start-1 select-none'>
          <h1 className="mb-8 text-[clamp(3rem,20vmin,20rem)] font-extrabold leading-none tracking-tighter whitespace-nowrap " aria-label={slice.primary.first_name + ' ' + slice.primary.last_name}>
            <span className='block text-slate-300'>{renderLetters(slice.primary.first_name, 'first')}</span>
            <span className='-mt-[.2em] text-slate-500'>{renderLetters(slice.primary.last_name, 'last')}</span>
          </h1>
