...
/**
 * Item in *TechList → Default → Primary → Technologies*
 */
export interface TechListSliceDefaultPrimaryTechnolgiesItem {
  /**
   * Tech name field in *TechList → Default → Primary → Technologies*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.technolgies[].tech_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  tech_name: prismic.KeyTextField;

  /**
   * Color field in *TechList → Default → Primary → Technologies*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.technolgies[].color
...
export interface TechListSliceDefaultPrimary {
  ...
  /**
   * Technologies field in *TechList → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.technolgies[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  technolgies: prismic.GroupField<
    Simplify<TechListSliceDefaultPrimaryTechnolgiesItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      TechListSlice,
      TechListSliceDefaultPrimaryTechnolgiesItem,
